...
static int pc_branch = -1;
static int branch_errors = 0;
static bool branch_bool = false;
...
void dBranch_err_count(int npc);
...
{
  printf("Stall branch estático: %d\n", branch_errors);
