...
{ 
  ...
  if(fwrite(&ac_pc, sizeof(int), 1, f) != 1) //Escreve ac_pc no arquivo;
  {
	  printf("Erro na escrita do ac_pc.\n");
	  exit(1);
  }
  if(fwrite("\n", sizeof(char), 1, f) != 1)
  {
...
void ac_behavior( lb )
{
  ...
  if(fwrite(&(RB[rs]+ imm), sizeof(int), 1, f) != 1) //Escreve ac_pc no arquivo;
  {
	  printf("Erro na escrita do RB[rs] + imm.\n");
	  exit(1);
  }
  if(fwrite("\n", sizeof(char), 1, f) != 1)
  {
...
void ac_behavior( lwl ) //check later
{
...
void ac_behavior( lwr ) //check later
{
...
void ac_behavior( swl ) //check later
{
...
void ac_behavior( swr ) //check later
{
